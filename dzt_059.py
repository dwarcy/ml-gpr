...
mygpr.importdata('/home/renata/ml-gpr/radargrama/FILE__059 P_1.DZT')
mygpr.setZeroTime(0.53)
...
inicio = x_min
fim = x_max
largura_janela = 0.7          # X-range
passo = 0.7                   # deslocamento
...
while x + largura_janela <= fim:
    ...
    mygpr.printProfile(nome_arquivo, color='gray', contrast=25, yrng=[0,4], xrng=xrng, dpi=600)
    ...
    pix.save(f"/home/renata/ml-gpr/imagens/dzt_059/frame_{i:02d}.jpg")

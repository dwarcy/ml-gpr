...
mygpr.importdata('/home/renata/ml-GPR/APP_TOTAL P_1.DZT')
mygpr.setZeroTime(0.7)
...
while x + largura_janela <= fim:
    ...
    mygpr.printProfile(nome_arquivo, color='gray', contrast=8, yrng=yrng, xrng=xrng, dpi=600)

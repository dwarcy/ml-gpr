...
mygpr = gp.gprpyProfile()
mygpr.importdata('/home/renata/ml-gpr/radargrama/FILE__008 P_1.DZT')
mygpr.setZeroTime(1.26)
...
while x + largura_janela <= fim:
    ...
    mygpr.printProfile(nome_arquivo, color='gray', contrast=8, yrng=[0,7], xrng=xrng, dpi=600)
    ...
    pix.save(f"/home/renata/ml-gpr/imagens/dzt_008/frame_{i:02d}.jpg")

...
mygpr.importdata('/home/renata/ml-gpr/radargrama/FILE__022 P_1.DZT')
...
while x + largura_janela <= fim:
    ...
    mygpr.printProfile(nome_arquivo, color='gray', contrast=9, yrng=[0,7], xrng=xrng, dpi=600)
    ...
    pix.save(f"/home/renata/ml-gpr/imagens/dzt_022/frame_{i:02d}.jpg")

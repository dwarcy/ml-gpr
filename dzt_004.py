...
mygpr = gp.gprpyProfile()
mygpr.importdata('/home/renata/ml-gpr/radargrama/FILE__004 P_1.DZT')
mygpr.setZeroTime(1.15)
...
inicio = x_min
fim = x_max
largura_janela = 0.6          # X-range
passo = 0.6                   # deslocamento
...
while x + largura_janela <= fim:
    ...
    mygpr.printProfile(nome_arquivo, color='gray', contrast=8, yrng=[0,6], xrng=xrng, dpi=600)
    ...
    pix.save(f"/home/renata/ml-gpr/imagens/dzt_004/frame_{i:02d}.jpg")

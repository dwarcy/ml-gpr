...
mygpr.importdata('/home/renata/ml-gpr/radargrama/FILE__058 P_1.DZT')
...
inicio = x_min
fim = x_max
largura_janela = 0.9          # X-range
passo = 0.9                   # deslocamento
...
while x + largura_janela <= fim:
    ...
    mygpr.printProfile(nome_arquivo, color='gray', contrast=24, yrng=[0,6], xrng=xrng, dpi=600)
    ...
    pix.save(f"/home/renata/ml-gpr/imagens/dzt_058/frame_{i:02d}.jpg")

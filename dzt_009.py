...
mygpr = gp.gprpyProfile()
mygpr.importdata('/home/renata/ml-gpr/radargrama/FILE__009 P_1.DZT')
mygpr.setZeroTime(1.08)
...
while x + largura_janela <= fim:
    ...
    mygpr.printProfile(nome_arquivo, color='gray', contrast=9, yrng=[0,8], xrng=xrng, dpi=600)
    ...
    pix.save(f"/home/renata/ml-gpr/imagens/dzt_009/frame_{i:02d}.jpg")

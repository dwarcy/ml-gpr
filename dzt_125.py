...
mygpr.importdata('/home/renata/ml-gpr/radargrama/FILE__125 P_1.DZT')
mygpr.setZeroTime(1.03)
...
while x + largura_janela <= fim:
    ...
    mygpr.printProfile(nome_arquivo, color='gray', contrast=10, yrng=[0,6], xrng=xrng, dpi=600)
    ...
    pix.save(f"/home/renata/ml-gpr/imagens/dzt_125/frame_{i:02d}.jpg")

...
mygpr.importdata('/home/renata/ml-gpr/radargrama/FILE__057 P_1.DZT')
mygpr.setZeroTime(1.17)
...
while x + largura_janela <= fim:
    ...
    mygpr.printProfile(nome_arquivo, color='gray', contrast=24, yrng=[0,5], xrng=xrng, dpi=600)
    ...
    pix.save(f"/home/renata/ml-gpr/imagens/dzt_057/frame_{i:02d}.jpg")
